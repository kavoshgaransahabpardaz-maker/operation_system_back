...
Revises: f2a3b4c5d6e7, d4e5f6a7b8c9
Create Date: 2026-07-16

Merges hasti_features (f2a3b4c5d6e7) and add_missing_enum_values (d4e5f6a7b8c9) branches.
"""
...
down_revision: Union[str, tuple] = ("f2a3b4c5d6e7", "d4e5f6a7b8c9")
branch_labels = None
depends_on = None
